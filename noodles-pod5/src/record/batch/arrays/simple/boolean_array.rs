...
impl BooleanArray {
    ...
    /// Creates a new wrapper arround an Arrow [`BooleanArray`](array::BooleanArray).
    #[inline]
    #[must_use]
    pub fn from_raw_parts(array: array::BooleanArray) -> Self {
        Self(array)
    }

    /// Consumes the wrapper and returns the underlying Arrow [`BooleanArray`](array::BooleanArray).
    #[inline]
    #[must_use]
    pub fn to_raw_parts(self) -> (array::BooleanArray) {
        (self.0)
    }
