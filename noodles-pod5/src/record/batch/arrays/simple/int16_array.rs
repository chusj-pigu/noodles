...
impl Int16Array {
    ...
    #[inline]
    #[must_use]
    pub fn new(array: array::Int16Array) -> Self {
        Int16Array(array)
    }
    ...
    #[inline]
    #[must_use]
    pub fn as_int16_array(&self) -> &array::Int16Array {
        &self.0
    }
    ...
    #[inline]
    #[must_use]
    pub fn to_int16_array(self) -> array::Int16Array {
        self.0
    }
