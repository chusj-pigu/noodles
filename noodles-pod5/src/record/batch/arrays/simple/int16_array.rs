...
/// Thin wrapper around Arrow's [`Int16Array`].
///
...
#[repr(transparent)]
pub struct Int16Array(array::Int16Array);

impl Int16Array {

    /// Attempts to create a new [`Int16Array`] from an Arrow [`ArrayRef`],
    ...
    /// Creates a new wrapper arround an Arrow [`Int16Array`](array::Int16Array).
    #[inline]
    #[must_use]
    pub fn from_raw_parts(array: array::Int16Array) -> Self {
        Self(array)
    }

    /// Consumes the wrapper and returns the underlying Arrow [`Int16Array`](array::Int16Array).
    #[inline]
    #[must_use]
    pub fn to_raw_parts(self) -> (array::Int16Array) {
        (self.0)
    }
