...
impl Int64Array {
    ...
    #[inline]
    #[must_use]
    pub fn new(array: array::Int64Array) -> Self {
        Int64Array(array)
    }
    ...
    #[inline]
    #[must_use]
    pub fn as_int64_array(&self) -> &array::Int64Array {
        &self.0
    }
    ...
    #[inline]
    #[must_use]
    pub fn to_int64_array(self) -> array::Int64Array {
        self.0
    }
