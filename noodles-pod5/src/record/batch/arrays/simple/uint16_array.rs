...
impl UInt16Array {
    ...
    #[inline]
    #[must_use]
    pub fn new(array: array::UInt16Array) -> Self {
        UInt16Array(array)
    }
    ...
    #[inline]
    #[must_use]
    pub fn as_uint16_array(&self) -> &array::UInt16Array {
        &self.0
    }
    ...
    #[inline]
    #[must_use]
    pub fn to_uint16_array(self) -> array::UInt16Array {
        self.0
    }
    ...
    pub fn index(&self, index: BatchRowIndex) -> Result<Option<u16>, RowIndexOutOfBounds> {
        let array = self.as_uint16_array();
