...
impl UInt64Array {
    ...
    /// Attempts to create a new [`UInt64Array`] from an Arrow [`ArrayRef`],
    ...
    /// Creates a new wrapper arround an Arrow [`UInt64Array`](array::UInt64Array).
    #[inline]
    #[must_use]
    pub fn from_raw_parts(array: array::UInt64Array) -> Self {
        Self(array)
    }

    /// Consumes the wrapper and returns the underlying Arrow [`UInt64Array`](array::UInt64Array).
    #[inline]
    #[must_use]
    pub fn to_raw_parts(self) -> (array::UInt64Array) {
        (self.0)
    }
