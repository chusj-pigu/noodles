...
impl UInt8Array {
    ...
    #[inline]
    #[must_use]
    pub fn new(array: array::UInt8Array) -> Self {
        UInt8Array(array)
    }
    ...
    #[inline]
    #[must_use]
    pub fn as_uint8_array(&self) -> &array::UInt8Array {
        &self.0
    }
    ...
    #[inline]
    #[must_use]
    pub fn to_uint8_array(self) -> array::UInt8Array {
        self.0
    }
