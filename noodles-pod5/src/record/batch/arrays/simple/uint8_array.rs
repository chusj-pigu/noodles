...
/// Thin wrapper around Arrow's [`UInt8Array`].
///
...
#[repr(transparent)]
pub struct UInt8Array(array::UInt8Array);

impl UInt8Array {

    /// Attempts to create a new [`UInt8Array`] from an Arrow [`ArrayRef`],
    ...
    /// Creates a new wrapper arround an Arrow [`UInt8Array`](array::UInt8Array).
    #[inline]
    #[must_use]
    pub fn from_raw_parts(array: array::UInt8Array) -> Self {
        Self(array)
    }

    /// Consumes the wrapper and returns the underlying Arrow [`UInt8Array`](array::UInt8Array).
    #[inline]
    #[must_use]
    pub fn to_raw_parts(self) -> (array::UInt8Array) {
        (self.0)
    }
